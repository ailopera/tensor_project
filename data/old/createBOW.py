...
def createBOWModel(cleanTrainBodies, printLogs=False):
    ...
    # TODO: Obtenemos los datos de test a partir del modelo ya entrenado
    # TODO: El modelo de fit lo hacemos a partir de las noticias y los headlines, hay que cambiar eso
    # vectorizer.transform(cleantestHeadLines)
    # vectorizer.transform(cleantestBodies)
